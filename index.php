...
<body>
    ...
    <div class="left-container">
      ...
      <div class="inf-container">
        <table class="reg-table">
          ...
          <tr>
            <td id="stackPointer" colspan="2" class="full-row">Указатель стека (УС): <span class="sp-value">FFFF</span>
            </td>
          </tr>
          <tr>
            <td id="programCounter" colspan="2" class="full-row">Счётчик команд (СК): <span class="pc-value">0000</span>
            </td>
          </tr>
        </table>
        <div class="data-block">
  ...
  <script src="./core/opcode_maps.js" defer></script>
